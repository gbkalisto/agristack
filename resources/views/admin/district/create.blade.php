                ...
                <div class="card">
                    <form action="{{ route('admin.districts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body p-4">
                            ...
                            {{-- Division select --}}
                            <div class="row mb-3">
                                <label for="division_id" class="col-sm-3 col-form-label">Select Division (Mandal) <span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                            ...
                            {{-- Name --}}
                            <div class="row mb-3">
                                <label for="name" class="col-sm-3 col-form-label">Enter District Name <span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" id="name" placeholder="District Name"
                                            value="{{ old('name') }}">
                                    </div>
                                    @error('name')
                                        <div class="text-danger mt-1"><small>{{ $message }}</small></div>
