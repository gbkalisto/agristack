                ...
                <div class="card">
                    <form action="{{ route('admin.admins.update', $admin) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body p-4">
                            ...
                            {{-- Name --}}
                            <div class="row mb-3">
                                <label for="input49" class="col-sm-3 col-form-label">Enter User Name</label>
                                <div class="col-sm-9">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" name="address" id="inputAddress"
                                            placeholder="Address">{{ old('address', $admin->address ?? '') }}</textarea>
                                    </div>
                                    @error('address')
                                        <div class="text-danger mt-1"><small>{{ $message }}</small></div>
                                    @enderror
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check">
                                        <input class="form-check-input" name="is_active" type="checkbox" value="1"
                                            id="input54"
                                            {{ old('is_active', $admin->is_active ?? false) ? 'checked' : '' }}>
                            ...
                            {{-- Roles Checkbox Group --}}
                            <div class="row mb-3">
                                <label class="col-sm-3 col-form-label">Roles <span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                        ...
                                        @foreach ($roles as $role)
                                            <div class="form-check me-3">
                                                <input class="form-check-input" type="checkbox" name="roles[]"
                                                    ...
                                                    {{ (old('roles') && in_array($role->name, old('roles'))) || (isset($admin) && $admin->hasRole($role->name))
                                                        ? 'checked'
                                                        : '' }}>
