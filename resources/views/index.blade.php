...
<head>
  ...
  <style>
    ...
    .top-nav a {
      color: #ffd84d; /* yellow like govt site */
    ...
    .nic-logo {
  margin-right: 30px;   /* NIC ke baad space */
  display: inline-block;
    ...
    .bg1 { background: linear-gradient(135deg,#9b8df3,#bfa7ff); }
    .bg2 { background: linear-gradient(135deg,#ff7eb3,#ffb6d5); }
    .bg3 { background: linear-gradient(135deg,#fbc531,#ffeaa7); }
...
<div class="container-fluid py-5">
  <div class="row align-items-center justify-content-center min-vh-100">
    ...
    <div class="col-lg-6 col-md-7 text-center text-md-start mb-4 mb-md-0 px-5">
      ...
      <p class="mt-3 w-75">Farmer Registry has been started as an important initiative for the farmers in the state of Uttar Pradesh. Under this system, a unique farmer ID (Farmer ID) will be created for each farmer.HELPDESK 0522 2317003</p>
    </div>
    ...
    <div class="col-lg-4 col-md-5 d-flex justify-content-center">
      <div class="login-card w-100">
        ...
        <div class="mb-3">
          <input id="username" type="text" class="form-control" placeholder="Insert User ID / Email">
        </div>
        ...
        <button class="btn btn-main w-100 mt-2" onclick="window.location.href='dashboard.html'">Log In</button>

        <button id="createBtn" class="btn create-btn w-100 mt-3 d-none">Create New User Account</button>
      </div>
    </div>
