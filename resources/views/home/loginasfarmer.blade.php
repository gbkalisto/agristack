    ...
    <div class="container-fluid py-5">
        <div class="row align-items-center justify-content-center min-vh-100">
            ...
            <div class="col-lg-6 col-md-7 text-center text-md-start mb-4 mb-md-0 px-5">
                <h1 class="fw-bold display-5"><img src="{{ asset('/') }}img/agristacklogo.png" alt="Logo"
                    ...
                    <form method="POST" action="{{ route('login') }}" id="loginForm" novalidate>
                        ...
                        <div class="mb-3">
                            <input id="phone" name="phone" type="number"
                                ...
                                placeholder="Insert Registered Mobile Number" autocomplete="off"
                                value="{{ old('phone') }}">
                        ...
                        <div class="alert alert-info small">
                            After login, an OTP will be sent to your registered mobile number for verification.
                        </div>
