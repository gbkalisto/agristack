        ...
        <div class="row align-items-center justify-content-center min-vh-100">
            ...
            <div class="col-lg-6 col-md-7 text-center text-md-start mb-4 mb-md-0 px-5">
                <h1 class="fw-bold display-5">
                    <img src="img/agristacklogo.png" alt="Logo"
                    ...
                    <form method="POST" action="{{ route('account.login.submit') }}" id="loginForm" novalidate>
                        ...
                        <div class="text-center mb-3">
                            ...
                            <div class="d-flex justify-content-center gap-2 mt-3">
                                <a href="{{ route('loginas.official') }}" class="role-btn active" style="text-decoration: none">Official
                                </a>
                                <a href="{{ route('loginas.farmer') }}" class="role-btn" style="text-decoration: none">Farmer</a>
                            </div>
                        </div>
