        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('documents.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body p-4">
                    ...
                    {{-- Aadhaar --}}
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">Aadhaar Card <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-check mb-4">
                        <input class="form-check-input" type="checkbox" id="confirm" {{ old('confirm') ? 'checked' : '' }}
                            checked required>
